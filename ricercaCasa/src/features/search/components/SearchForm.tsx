...
export function SearchForm() {
  ...
  return (
    <form
      className="mx-auto grid max-w-6xl gap-5 rounded-[2rem] border border-white bg-white p-6 shadow-[0_20px_60px_-28px_rgba(15,23,42,0.25)] lg:grid-cols-[1.2fr_1.2fr_1fr_auto] lg:items-end"
